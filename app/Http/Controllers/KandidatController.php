...
class KandidatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin/kandidat/kandidat', [
            'kandidat' => $kandidat
        ]);
    }
    public function tambah()
    {
        return view('admin/kandidat/tambahkandidat');
    }
    ...
    public function detail($id)
    {
        ...
        return view('/admin/kandidat/kandidatdetail', [
    ...
    public function edit($id)
    {
        ...
        return view('/admin/kandidat/editkandidat', [
            'edit' => $edit
        ]);
    }
